...
const ExtraSection1 = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 shadow w-full rounded-l-2xl rounded-r-2xl gap-4 md:gap-0">
            ...
            <div className=" flex justify-between items-center  px-6 bg-green-100 py-12 rounded-r-2xl rounded-l-2xl lg:rounded-l-none lg:gap-8 md:gap-4 md:mt-4 lg:mt-0">
