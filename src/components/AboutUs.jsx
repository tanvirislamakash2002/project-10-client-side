...
const AboutUs = () => {
    return (
      ...
      {/* Hero Section */}
      {/* <section className="relative custom-bg-400 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">
            Better Living Through Better Matching
          </h1>
          <p className="mt-6 max-w-3xl mx-auto text-xl text-blue-100">
            We're revolutionizing how people find roommates by focusing on compatibility, safety, and community.
          </p>
        </div>
      </section> */}
