...
const MobileHeader = ({user}) => {
    ...
    return (
<div className="navbar bg-white dark:bg-gray-800 shadow-sm lg:hidden px-6 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
    ...
    <div className="flex-none">
        <div className="avatar">
            <div className="w-8 h-8 rounded-full border border-green-200 dark:border-green-800">
                <img
