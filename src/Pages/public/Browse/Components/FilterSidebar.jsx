        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm space-y-6">
            ...
            <div>
                ...
                <div className="space-y-2">
                    {['Private Room', 'Shared Room', 'Studio', 'Master Bedroom'].map(type => (
            ...
            <div>
                ...
                <div className="space-y-2">
                    {['House', 'Apartment', 'Condo', 'Townhouse', 'Duplex', 'Studio'].map(type => (
                        <label key={type} className="flex items-center gap-2 cursor-pointer">
                            <input
                                type="checkbox"
            ...
            <div>
                ...
                <div className="space-y-2">
                    {['WiFi', 'Parking', 'Air Conditioning', 'Elevator'].map(amenity => (
