...
export const InquiryCard = ({ inquiry }) => {
    ...
    return (
        <div
            ...
            className={`p-4 border-b border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors ${selectedInquiry?.id === inquiry.id ? 'bg-blue-50 border-l-4 border-l-blue-600' : ''
